...
function startNextServer() {
  // Vérifier si le build standalone existe
  const standalonePath = path.join(__dirname, '../web/.next/standalone/server.js');
  const isDev = !fs.existsSync(standalonePath);
  ...
  if (isDev) {
    ...
    console.log('[Electron] Server path:', nextServerPath);
