-- AlterTable
ALTER TABLE "CatalogItem" ADD COLUMN "availability" TEXT;
ALTER TABLE "CatalogItem" ADD COLUMN "ean" TEXT;
ALTER TABLE "CatalogItem" ADD COLUMN "supplierName" TEXT;
ALTER TABLE "CatalogItem" ADD COLUMN "supplierSku" TEXT;
...
INSERT INTO "new_SystemSettings" ("activityLogsEnabled", "autoBackupEnabled", "backupFrequency", "createdAt", "emailNotificationsEnabled", "id", "notificationsEnabled", "updatedAt", "userId") SELECT "activityLogsEnabled", "autoBackupEnabled", "backupFrequency", "createdAt", "emailNotificationsEnabled", "id", "notificationsEnabled", "updatedAt", "userId" FROM "SystemSettings";
