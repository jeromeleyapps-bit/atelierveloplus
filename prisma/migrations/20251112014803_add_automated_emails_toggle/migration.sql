...
INSERT INTO "new_SystemSettings" ("activityLogsEnabled", "autoBackupEnabled", "backupFrequency", "createdAt", "emailApiKey", "emailFromAddress", "emailFromName", "emailNotificationsEnabled", "emailProvider", "hardDeleteEnabled", "id", "maintenanceMode", "notificationsEnabled", "requireAdmin2FA", "securityAlertsEnabled", "smtpHost", "smtpPass", "smtpPort", "smtpSecure", "smtpUser", "tunnelConfigured", "tunnelHostname", "updatedAt", "userId") SELECT "activityLogsEnabled", "autoBackupEnabled", "backupFrequency", "createdAt", "emailApiKey", "emailFromAddress", "emailFromName", "emailNotificationsEnabled", "emailProvider", "hardDeleteEnabled", "id", "maintenanceMode", "notificationsEnabled", "requireAdmin2FA", "securityAlertsEnabled", "smtpHost", "smtpPass", "smtpPort", "smtpSecure", "smtpUser", "tunnelConfigured", "tunnelHostname", "updatedAt", "userId" FROM "SystemSettings";
