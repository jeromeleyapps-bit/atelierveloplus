...
const lot7Files = [
  ...
  'src/hooks/useDashboardRevenue.ts',
...
console.log('🚀 Démarrage du traitement du Lot 7...\n');
console.log('📦 Lot 7 : 10 fichiers src/hooks\n');

let processed = 0;
let skipped = 0;
let totalOccurrences = 0;

lot7Files.forEach(file => {
...
console.log(`   Fichiers: ${56 + processed}/179 (${Math.round((56 + processed) / 179 * 100)}%)`);
console.log(`   Occurrences: ~${327 + totalOccurrences}/590 (${Math.round((327 + totalOccurrences) / 590 * 100)}%)`);
